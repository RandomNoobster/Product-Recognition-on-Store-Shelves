...
def solve_step_a():
    ...
    for scene_path in scene_paths:
        ...
        for model_path in model_paths:
            ...
            if des_model is None or des_scene is None or len(des_model) < 2 or len(des_scene) < 2:
                continue
            ...
            if len(good_matches) > MIN_MATCH_COUNT:
                ...
                if M is not None:
                    ...
                    scene_rgb = cv2.polylines(scene_rgb, [np.int32(dst)], True, (0, 255, 0), 3, cv2.LINE_AA)
